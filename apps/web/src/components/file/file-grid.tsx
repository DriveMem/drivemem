...
const TYPE_ICONS: Record<MockFile["type"], string> = {
  pdf: "📄",
  md: "📝",
  txt: "📃",
  image: "🖼️",
...
const STATUS_LABEL: Record<MockFile["parseStatus"], string> = {
  parsing: "解析中…",
  done: "已就绪",
  error: "解析失败",
}
...
export function FileGrid({ files = mockFiles }: { files?: MockFile[] }) {
