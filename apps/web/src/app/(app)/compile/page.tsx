...
import { Sparkles, Copy, Check, FileText, Upload, AlertCircle, Loader2, SearchX, BookOpen, PenLine, Search } from "lucide-react"
...
const examples = [
  { Icon: BookOpen, title: "Project handoff", desc: "Prepare context for a new team member or AI" },
  { Icon: PenLine, title: "Continue writing", desc: "Get background for a writing task" },
  { Icon: Search, title: "Research review", desc: "Compile relevant knowledge for analysis" },
]
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-6">
          {examples.map((ex) => (
            <button
              ...
              className="rounded-xl border border-zinc-200 bg-card p-4 text-left hover:border-brand-500/30 hover:shadow-sm transition"
            >
              <ex.Icon className="h-5 w-5 text-zinc-400 mb-2" />
