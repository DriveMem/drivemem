...
export const metadata = {
  title: "使用条款 - DriveMem",
  description: "DriveMem 使用条款和服务协议",
  openGraph: { title: "使用条款 - DriveMem", description: "DriveMem 使用条款和服务协议" },
}
    ...
    <div className="min-h-screen">
      ...
      <div className="mt-8 space-y-8 text-sm leading-relaxed text-muted-foreground">
        <section>
          ...
          <p>DriveMem 是一个基于人工智能的个人知识管理平台。你可以上传文档，AI 自动解析、理解并建立知识索引，随时通过对话获取文件内容的分析和回答。</p>
        </section>
        <section>
        ...
        <section>
          ...
          <p>你对上传的文件内容负责。请勿上传违法、侵权或不当内容。DriveMem 有权在发现违规内容时暂停或终止你的账号。</p>
        </section>
        <section>
          <h2 className="text-lg font-semibold text-foreground">AI 回答免责</h2>
          <p>AI 的回答基于你上传的文档内容生成，可能存在不准确或遗漏。DriveMem 不对 AI 回答的准确性做任何保证。重要决策请以原始文档为准。</p>
        </section>
        <section>
          <h2 className="text-lg font-semibold text-foreground">服务变更</h2>
          <p>DriveMem 保留随时修改服务功能、定价和使用条款的权利。重大变更会提前通知注册用户。</p>
        </section>
        <section>
