...
export default async function LandingPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-3 sm:px-4">
      <div className="max-w-2xl text-center space-y-8">
        <h1 className="text-3xl font-bold tracking-tight sm:text-5xl md:text-6xl">让 AI 记住你的一切</h1>
      ...
      <div className="mt-12 sm:mt-20 grid max-w-4xl grid-cols-1 gap-6 sm:gap-8 sm:grid-cols-3 px-2">
        {features.map((f) => (
      ...
      <p className="mt-10 sm:mt-16 text-xs text-muted-foreground">AI Drive — 你的个人 AI 数据基础平台</p>
    </div>
  )
}
