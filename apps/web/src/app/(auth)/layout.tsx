export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-gray-950 via-blue-950/50 to-gray-950 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full px-12">
          ...
          <p className="text-lg text-blue-200/80 mb-12">让 AI 记住你的一切</p>
          ...
          <div className="space-y-6 max-w-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">AI 自动解析你的文件内容</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <span className="text-2xl">💬</span>
              <div>
                ...
                <p className="text-sm text-gray-400">用自然语言和你的文件对话</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <span className="text-2xl">🔒</span>
              <div>
                ...
                <p className="text-sm text-gray-400">你的文件只属于你</p>
              </div>
            </div>
          </div>
        </div>
