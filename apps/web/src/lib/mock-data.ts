export interface MockFolder { id: string; name: string; parentId: string | null; children?: MockFolder[] }
export interface MockFile { id: string; name: string; type: 'pdf'|'txt'|'md'|'image'; size: number; folderId: string|null; createdAt: string; updatedAt: string; parseStatus: 'parsing'|'done'|'error'; parseError?: string }
export const mockFolders: MockFolder[] = [
  { id:'f1',name:'工作文档',parentId:null,children:[{id:'f1-1',name:'项目资料',parentId:'f1'},{id:'f1-2',name:'会议记录',parentId:'f1'}]},
  { id:'f2',name:'学习笔记',parentId:null,children:[{id:'f2-1',name:'AI 相关',parentId:'f2'}]},
