  ...
  return (
    <div className="flex items-center gap-2 text-xs text-tertiary">
      ...
      <button
        ...
        className="min-h-12 min-w-12 sm:min-h-0 sm:min-w-0 inline-flex items-center justify-center rounded-lg border border-gray-200 px-3 py-2 hover:text-secondary hover:border-gray-300 transition-colors disabled:opacity-50"
        aria-label="Refresh"
      >
        <span
